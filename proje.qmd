...
2 adet veri setimiz bulunmaktadır. Bunlar; "İl ve evlilik süresine göre boşanmalar" ve "İl ve dava süresine göre boşanmalar".
...
Zaman içinde genel boşanma eğilimi incelendiğinde, 2020 yıllarında bir miktar düşüş dikkat çekmektedir. Bu yılda yaşanan azalma, dışsal faktörlerin etkisiyle (örneğin pandemi dönemi) açıklanabilir ancak bu grafikte dışsal nedenler analiz dışıdır. 2021 yılından itibaren boşanma sayılarında yeniden artış gözlemlenmektedir. Bu artış eğilimi, yıllar bazında pozitif bir trend olduğuna işaret eder. Özellikle Marmara, İç Anadolu ve Ege bölgelerinde yıllara göre istikrarlı bir artış eğilimi bulunmaktadır.
...
Analiz sonuçlarına göre Türkiye'de boşanma vakalarının büyük çoğunluğu 0–2 ay içinde sonuçlanmakta ve bu süreçte Marmara bölgesi, toplam boşanma içinde en yüksek paya sahiptir. Dava süresi arttıkça boşanma sayıları sistematik olarak düşmekte, özellikle 1 yılı aşan davalarda tüm bölgelerde gözle görülür bir azalma olmaktadır. Evlilik süresi açısından değerlendirildiğinde ise, hem kısa sürede hem de uzun sürede boşanma oranlarının yüksek olduğu, dolayısıyla evliliğin süresinin tek başına koruyucu bir faktör olmadığı görülmektedir. Bölgesel analizlerde Marmara, Ege ve İç Anadolu gibi büyük şehirlerin bulunduğu bölgelerde boşanma sayıları hem yüksek hem de daha çeşitli dava süresi aralıklarında dağılmıştır.
